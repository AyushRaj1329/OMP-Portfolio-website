  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        <h1 className="font-display text-d 4xl md:text-6xl lg:text-7xl font-bold text-[hsl(var(--primary-foreground))] leading-tight mb-6">
          QUALITY AND SAFETY <br/>
          IS OUR           <br />
          <span className="text-[hsl(var(--accent))]">COMMITMENT</span>
        </h1>

        <p className="max-w-2xl mx-auto text-[hsl(var(--primary-foreground)/0.8)] text-base md:text-lg mb-8">
          Providing reliable civil construction services including industrial buildings, road infrastructure, structural works and complete project development.
        </p>
